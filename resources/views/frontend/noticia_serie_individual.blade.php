...
<div class="container bg_main">		
	<div class="row topp">
		...
		<div class="col-md-9 col-md-offset-1">	
			...
			<span id="fecha_noticia">{{ $noticia->created_at->format('l jS \\of F Y h:i:s A') }} | {{ $noticia->created_at->diffForHumans() }} | <a href="{{ route('frontend.serie_individual', $noticia->serie_id) }}">{{ $noticia->serie->titulo_serie }}</a></span>
			<hr>
			<span><img id="imagen" src="{{ asset('img/noticias_series/' . $noticia->foto) }}" alt=""></span><br><br>
